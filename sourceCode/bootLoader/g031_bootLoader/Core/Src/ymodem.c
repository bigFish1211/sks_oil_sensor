...
/**
  ...
  * @retval The size of thepacket_data file
  */
int32_t Ymodem_Receive (uint8_t *buf)
{
  ...
  uint32_t DestinationAddress = BOOT_PRIMARY_ADDRESS;
            ...
            default:
              ...
              else
              {
                ...
                else
                {
                  ...
                  for (j = 0;(j < packet_length) && (FlashDestination <  DestinationAddress + size);j += 4)
                  {
